        ...
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="form-group">
                  ...
                  <input type="text" id="nama" name="nama" class="form-control" value="{{ $umkm->nama_ }}">
              </div>
              <div class="form-group">
              ...
              {{-- <div class="form-group">
                ...
                <select class="custom-select rounded-0" id="exampleSelectRounded0" name="id_umkm">
                  @foreach ($umkm as $p)
                      <option value="{{ $p->id }}" {{ $umkm->id_umkm == $p->id ? 'selected' : '' }}>{{ $p->nama }}</option>
                  @endforeach
              </select> --}}
              </div>
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <img src="{{ $umkm->logo }}" alt="Foto Awal" width="100">
                <input type="file" id="inputFotoProduk" class="form-control" name="logo" accept="assets\img\produk\">
            </div>
