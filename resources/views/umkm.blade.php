...
<section id="umkm-list" class="portfolio sections-bg pt-5 mt-5" style="padding-top: 120px;">
  <div class="container" data-aos="fade-up">
    ...
    <div class="portfolio-flters d-flex flex-row justify-content-center mb-4">
      <form class="d-flex w-75" method="GET" action="{{ route('listumkm.index') }}">
  ...
  <div class="card-body">
    <div class="d-flex align-items-center mb-3">
      ...
      <div class="ms-3">
        <h6 class="mb-1">
          <a href="{{ route('listumkm.show', $k->id) }}" class="text-decoration-none text-dark fw-semibold stretched-link">
            {{ $k->nama }}
          </a>
        </h6>
